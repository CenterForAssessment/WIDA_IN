...
### Transform the first year baseline referenced targets (1 to 6 year span) on OLD_SCALE to 1.0 to 6.0 performance level scale
WIDA_IN_SGP_LONG_Data_2026_NEW_SCALE[YEAR == "2026", PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_6_YEAR_PROJ_YEAR_1_CURRENT_OLD_SCALE:=SGPstateData[['WIDA']][['SGP_Configuration']][['widaACCESS_ss_to_pl']](as.character(as.numeric(GRADE)+1), ceiling(SCALE_SCORE_SGP_TARGET_BASELINE_6_YEAR_PROJ_YEAR_1_CURRENT))]
WIDA_IN_SGP_LONG_Data_2026_NEW_SCALE[YEAR == "2026", PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_5_YEAR_PROJ_YEAR_1_CURRENT_OLD_SCALE:=SGPstateData[['WIDA']][['SGP_Configuration']][['widaACCESS_ss_to_pl']](as.character(as.numeric(GRADE)+1), ceiling(SCALE_SCORE_SGP_TARGET_BASELINE_5_YEAR_PROJ_YEAR_1_CURRENT))]
WIDA_IN_SGP_LONG_Data_2026_NEW_SCALE[YEAR == "2026", PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_4_YEAR_PROJ_YEAR_1_CURRENT_OLD_SCALE:=SGPstateData[['WIDA']][['SGP_Configuration']][['widaACCESS_ss_to_pl']](as.character(as.numeric(GRADE)+1), ceiling(SCALE_SCORE_SGP_TARGET_BASELINE_4_YEAR_PROJ_YEAR_1_CURRENT))]
WIDA_IN_SGP_LONG_Data_2026_NEW_SCALE[YEAR == "2026", PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_3_YEAR_PROJ_YEAR_1_CURRENT_OLD_SCALE:=SGPstateData[['WIDA']][['SGP_Configuration']][['widaACCESS_ss_to_pl']](as.character(as.numeric(GRADE)+1), ceiling(SCALE_SCORE_SGP_TARGET_BASELINE_3_YEAR_PROJ_YEAR_1_CURRENT))]
WIDA_IN_SGP_LONG_Data_2026_NEW_SCALE[YEAR == "2026", PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_2_YEAR_PROJ_YEAR_1_CURRENT_OLD_SCALE:=SGPstateData[['WIDA']][['SGP_Configuration']][['widaACCESS_ss_to_pl']](as.character(as.numeric(GRADE)+1), ceiling(SCALE_SCORE_SGP_TARGET_BASELINE_2_YEAR_PROJ_YEAR_1_CURRENT))]
WIDA_IN_SGP_LONG_Data_2026_NEW_SCALE[YEAR == "2026", PROFICIENCY_LEVEL_SGP_TARGET_BASELINE_1_YEAR_PROJ_YEAR_1_CURRENT_OLD_SCALE:=SGPstateData[['WIDA']][['SGP_Configuration']][['widaACCESS_ss_to_pl']](as.character(as.numeric(GRADE)+1), ceiling(SCALE_SCORE_SGP_TARGET_BASELINE_1_YEAR_PROJ_YEAR_1_CURRENT))]


### Transform the first year baseline referenced targets (1 to 6 year span) from OLD_SCALE to NEW_SCALE
WIDA_IN_SGP_LONG_Data_2026_NEW_SCALE[YEAR == "2026", SCALE_SCORE_SGP_TARGET_BASELINE_6_YEAR_PROJ_YEAR_1_CURRENT_NEW_SCALE:=SGPstateData[['WIDA']][['SGP_Configuration']][['ss_2026_scale_score_transformation_function']] (as.numeric(GRADE)+1, ceiling(SCALE_SCORE_SGP_TARGET_BASELINE_6_YEAR_PROJ_YEAR_1_CURRENT), direction = "OLD_to_NEW")]
