##########################################################################################
###
### Script for calculating SGPs for 2021-2022 WIDA/ACCESS Indiana
###
##########################################################################################
...
load("Data/WIDA_IN_Data_LONG_2022.Rdata")

###   Add single-cohort baseline matrices to SGPstateData
SGPstateData <- SGPmatrices::addBaselineMatrices("WIDA_IN", "2022")

### Run analyses
WIDA_IN_SGP <- updateSGP(
		WIDA_IN_SGP,
		WIDA_IN_Data_LONG_2022,
